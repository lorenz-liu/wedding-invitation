...
export const images = {
  ...
  signatureGaoGold: resolveImageAssetPath("images/signature-gao-gold.webp"),
  signatureNiuGold: resolveImageAssetPath("images/signature-niu-gold.webp"),
  gown: resolveImageAssetPath("images/gown.webp"),
  iconsNext: resolveImageAssetPath("images/icons-next.webp"),
  iconsUndo: resolveImageAssetPath("images/icons-undo.webp"),
  iconsRedo: resolveImageAssetPath("images/icons-redo.webp"),
} as const;
...
const IMAGE_PRELOAD_BYTES: Record<keyof typeof images, number> = {
  ...
  signatureGao: 11_812,
  signatureNiu: 13_142,
  signatureGaoGold: 156_012,
  signatureNiuGold: 132_714,
  gown: 311_742,
  iconsNext: 306,
  iconsUndo: 286,
  iconsRedo: 294,
