  ...
  return (
    <View className="page page-life">
      <View className="content-wrapper">
        ...
        <AnimatedView animation="fadeInUp" isActive={isActive} delay={200} duration={800}>
        ...
        <AnimatedView animation="fadeInScale" isActive={isActive} delay={500} duration={600}>
        ...
        <AnimatedView animation="fadeInUp" isActive={isActive} delay={700} duration={800}>
